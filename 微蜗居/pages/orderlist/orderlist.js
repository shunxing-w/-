...
Page({
  ...
  receive:function(event){
    ...
    console.log(id);
    wx.request({
      url: "https://www.weiwoju.com/WechatApplet/customerGetCoupon",
      data:{
        coupon_id:id,
        order_no:orderno,
  ...
  getPayInfo: function (event) {
    ...
    wx.request({
      url: "https://www.weiwoju.com/WechatApplet/getPayInfo",
      data: {
        no: no,
        session_rd: session_rd,
        ver_no: app.data.edition
  ...
  Cancel_order: function (event) {
    ...
    wx.showModal({
      ...
      success: function (res) {
        if (res.confirm) {
          wx.request({
            url: 'https://www.weiwoju.com/WechatApplet/orderDeliveryCancel',
            data: {
              no: no,
              session_rd: session_rd,
              ver_no: app.data.edition
  ...
  orderlist: function (id,session_id) {
    ...
    var that = this;
    wx.request({
      url: 'https://www.weiwoju.com/WechatApplet/orderInfo',
      data: {
        session_rd: session_rd,
        id: id,
        ver_no: app.data.edition
